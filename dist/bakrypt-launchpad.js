...
`,Oo=class extends Ae{constructor(){super(...arguments),this.formSubmitController=new lo(this),this.hasSlotController=new io(this,"help-text","label"),this.hasFocus=!1,this.size="medium",this.value="",this.filled=!1,this.label="",this.helpText="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver((()=>this.setTextareaHeight())),this.updateComplete.then((()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)}))}firstUpdated(){this.invalid=!this.input.checkValidity()}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver.unobserve(this.input)}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(t){return t?("number"==typeof t.top&&(this.input.scrollTop=t.top),void("number"==typeof t.left&&(this.input.scrollLeft=t.left))):{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(t,e,o="none"){this.input.setSelectionRange(t,e,o)}setRangeText(t,e,o,r="preserve"){this.input.setRangeText(t,e,o,r),this.value!==this.input.value&&(this.value=this.input.value,uo(this,"sl-input")),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight(),uo(this,"sl-input"),uo(this,"sl-change"))}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.invalid=!this.input.checkValidity()}handleBlur(){this.hasFocus=!1,uo(this,"sl-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),uo(this,"sl-change")}handleDisabledChange(){this.input.disabled=this.disabled,this.invalid=!this.input.checkValidity()}handleFocus(){this.hasFocus=!0,uo(this,"sl-focus")}handleInput(){this.value=this.input.value,this.setTextareaHeight(),uo(this,"sl-input")}handleRowsChange(){this.setTextareaHeight()}handleValueChange(){this.invalid=!this.input.checkValidity()}setTextareaHeight(){"auto"===this.resize?(this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=void 0}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),o=!!this.label||!!t,r=!!this.helpText||!!e;return ne`
    ...
    `}};Oo.styles=Ho,eo([yo(".textarea__control")],Oo.prototype,"input",2),eo([go()],Oo.prototype,"hasFocus",2),eo([vo({reflect:!0})],Oo.prototype,"size",2),eo([vo()],Oo.prototype,"name",2),eo([vo()],Oo.prototype,"value",2),eo([vo({type:Boolean,reflect:!0})],Oo.prototype,"filled",2),eo([vo()],Oo.prototype,"label",2),eo([vo({attribute:"help-text"})],Oo.prototype,"helpText",2),eo([vo()],Oo.prototype,"placeholder",2),eo([vo({type:Number})],Oo.prototype,"rows",2),eo([vo()],Oo.prototype,"resize",2),eo([vo({type:Boolean,reflect:!0})],Oo.prototype,"disabled",2),eo([vo({type:Boolean,reflect:!0})],Oo.prototype,"readonly",2),eo([vo({type:Number})],Oo.prototype,"minlength",2),eo([vo({type:Number})],Oo.prototype,"maxlength",2),eo([vo({type:Boolean,reflect:!0})],Oo.prototype,"required",2),eo([vo({type:Boolean,reflect:!0})],Oo.prototype,"invalid",2),eo([vo()],Oo.prototype,"autocapitalize",2),eo([vo()],Oo.prototype,"autocorrect",2),eo([vo()],Oo.prototype,"autocomplete",2),eo([vo({type:Boolean})],Oo.prototype,"autofocus",2),eo([vo()],Oo.prototype,"enterkeyhint",2),eo([vo({type:Boolean})],Oo.prototype,"spellcheck",2),eo([vo()],Oo.prototype,"inputmode",2),eo([co("disabled",{waitUntilFirstUpdate:!0})],Oo.prototype,"handleDisabledChange",1),eo([co("rows",{waitUntilFirstUpdate:!0})],Oo.prototype,"handleRowsChange",1),eo([co("value",{waitUntilFirstUpdate:!0})],Oo.prototype,"handleValueChange",1),Oo=eo([bo("sl-textarea")],Oo);var Bo=Rt`
  ${Te}
